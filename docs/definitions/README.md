...
This chapter explains the various options for defining class models.

* [Attributes](1-attributes.md)
* [Collection Attributes](2-collection-attributes.md)
* [Associations](3-associations.md)
